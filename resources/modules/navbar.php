<nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarColor03">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" onclick="event.preventDefault();" href="#" data-toggle="modal" data-target="#howWorksModal">How It Works</a>
                </li>
            </ul>
...
<div class="modal fade" id="howWorksModal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <video src="assets/videos/howworks.mp4" controls></video>
            </div>
