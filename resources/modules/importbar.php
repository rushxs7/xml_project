            ...
            <form id="importForm">
                <div class="input-group">
                    ...
                    <div class="input-group-append">
                        <button id="importButton" class="btn btn-primary" onclick="event.preventDefault();"><i id="importIcon" class="fas fa-file-import"></i><i id="loadingIcon" class="fas fa-sync fa-spin" style="display: none;"></i>&nbsp;&nbsp;Import</button>
                    </div>
                </div>
            </form>
